...
from model.my_discriminator import Discriminator2,Discriminator2_patch,Discriminator2_patch3
...
def main():
    ...
    model_D3 = Discriminator2_patch3(num_classes=args.num_classes)
    if args.restore_from_D is not None:
