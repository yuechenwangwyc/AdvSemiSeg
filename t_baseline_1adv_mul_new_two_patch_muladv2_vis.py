...
from model.my_discriminator import Discriminator2,Discriminator2_mul2
...
def main():
    ...
    model_DS = []
    for i in range(20):
        model_DS.append(Discriminator2_mul2(num_classes=args.num_classes))
