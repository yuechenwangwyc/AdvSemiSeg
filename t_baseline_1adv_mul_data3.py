...
from dataset.voc_dataset2 import VOCDataSet, VOCGTDataSet
...
IMG_MEAN = np.array((10.00000000,10.00000000,10.00000000), dtype=np.float32)
#IMG_MEAN = np.array((50.00000000,50.0000000000,50.00000000), dtype=np.float32)
